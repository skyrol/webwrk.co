<?php
	...
	$ocdi_slides_to_revolution = array(
		trailingslashit( get_template_directory() ) . 'demo/15/home.zip'
	);
	...
	$ocdi_fields_to_change = array(
	  ...
	  'options_global_header_tilte_typo' => '{"size":"42px","color":"#444444","weight":"600"}',
	  ...
	  'options_global_page_headings_typo' => '{"weight":"500","font_family":"Poppins","font_variants":["700","600","500","regular","300"],"font_subsets":["latin-ext","latin","devanagari"]}',
