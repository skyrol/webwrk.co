<?php
	...
	$ocdi_slides_to_revolution = array(
		trailingslashit( get_template_directory() ) . 'demo/27/home.zip'
	);

	$ocdi_fields_to_change = array(
	  'options_global_page_brand_color' => '#404044',
	  ...
	  'options_global_page_headings_typo' => '{"weight":"600","font_family":"Poppins","font_variants":["300","regular","500","600","700"],"font_subsets":["devanagari","latin","latin-ext"]}',
	  ...
	  'options_global_page_custom_css' => 'ul.woo-products .wc-product-title-wrap {background: #fff;}',
	  ...
	  'options_global_side_panel_typo' => '{"weight":"500"}',
	  'options_global_side_panel_text' => 'Danish Home Interior & Decoration',
	  'options_global_side_panel_social' => 'a:4:{i:0;s:8:"facebook";i:1;s:7:"twitter";i:2;s:10:"googleplus";i:3;s:8:"linkedin";}',
	  'options_global_header_menu_text_typo' => '{"color":"#404044"}',
	  'options_global_header_background_color' => '#f8f8f8',
	  ...
	  'options_global_woocommerce_page_background_color' => '#f9f9f9',
	  'options_global_menu_hamburger_align' => 'inside_panel',
	  'options_global_fullscreen_menu_style' => 'default',
	  'options_global_fullscreen_menu_text_typo' => '{"color":"#404044"}',
