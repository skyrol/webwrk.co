...
function norebro_enqueue_admin_style() {
	...
	wp_enqueue_script( 'select2', get_template_directory_uri() . '/assets/js/select2.min.js' );
...
function norebro_enqueue_own_scripts() {
	...
	wp_enqueue_script( 'aos', get_template_directory_uri() . '/assets/js/aos.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'isotope', get_template_directory_uri() . '/assets/js/isotope.pkgd.min.js', array( 'jquery' ), false, true );
	wp_enqueue_script( 'jquery-mega-menu', get_template_directory_uri() . '/assets/js/jquery.mega-menu.min.js', array( 'jquery' ), false, true);
	...
	if ( NorebroHelper::is_script_required( 'smooth-scroll' ) ) { // Smooth scroll
		wp_enqueue_script( 'scroll-smooth', get_template_directory_uri() . '/assets/js/scroll-smooth.min.js', array('jquery'), false, true );
	}
	if ( NorebroHelper::is_script_required( 'multiscroll' ) ) { // Multiscreen
		wp_enqueue_script( 'multiscroll', get_template_directory_uri() . '/assets/js/jquery.multiscroll.min.js', array( 'jquery' ), '1.0.0', true );
	}
	if ( NorebroHelper::is_script_required( 'chart-box' ) ) { // Chart box
		wp_enqueue_script( 'jquery-easypiechart', get_template_directory_uri() . '/assets/js/jquery.easypiechart.min.js', array('jquery'), false, true );
	}
	...
	if ( NorebroHelper::is_script_required( 'one-page-scroll' ) ) { // One page scroll
		wp_enqueue_script( 'page-scroll', get_template_directory_uri() . '/assets/js/jquery.onepage-scroll.min.js', array( 'jquery' ), '1.0.0', true );
	}
    ...
    if (NorebroHelper::is_script_required('google-maps')) { // Google Maps
        wp_enqueue_script('jquery-maps', get_template_directory_uri() . '/assets/js/jquery.google-maps.min.js', array('jquery'), '1.0.0', true);
    }
