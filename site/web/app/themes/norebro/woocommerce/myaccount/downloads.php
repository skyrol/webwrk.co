...
<h4 class="title"><?php esc_html_e( 'Downloads', 'norebro' ); ?></h4>

<?php if ( $has_downloads ) : ?>

	<table class="woocommerce-MyAccount-downloads woo-my-orders-table">
		<thead>
			<tr>
							...
							if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
								...
								switch ( $column_id ) {
									...
									case 'download-remaining' :
										echo is_numeric( $download['downloads_remaining'] ) ? esc_html( $download['downloads_remaining'] ) : esc_html__( '&infin;', 'norebro' );
										break;
										...
										<?php
											$actions = array(
												'download'  => array(
													...
													'name' => esc_html__( 'Download', 'norebro' ),
												),
											);
...
<?php else : ?>
	<div class="message-box message-box-primary message-download woo-message-box">
		<?php esc_html_e( 'No downloads available yet.', 'norebro' ); ?>
