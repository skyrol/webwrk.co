	...
	<div class="vc_row">
		...
		<div class="vc_col-md-6 woo-my-address">
			<div class="wrap">
				...
				<address>
					<?php echo esc_html( $address = $order->get_formatted_billing_address() ) ? $address : esc_html__( 'N/A', 'norebro' ); ?>
				</address>
			</div>
		</div>
	...
	<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() ) : ?>
		...
		<div class="vc_col-md-6 woo-my-address">
			<div class="wrap">
				...
				<address>
					<?php echo esc_html( $address = $order->get_formatted_shipping_address() ) ? $address : esc_html__( 'N/A', 'norebro' ); ?>
				</address>
			</div>
		</div>
	</div><!--.col2-set-->
