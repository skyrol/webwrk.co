...
?>
<div class="blog-grid grid-1<?php echo esc_attr( $blog_grid_class ); ?>" <?php echo esc_attr( $anim_attrs ); ?>>

	<header>
		<?php if ( $norebro_post['media']['video'] ) : // video ?>
		<?php vprintf('%s', $norebro_post['media']['video']) ?>
	...
	<div class="content">
		...
		<p>
			<?php echo esc_html( $norebro_post['preview'] ); ?>
		</p>
		<?php endif; ?>
	</div>
