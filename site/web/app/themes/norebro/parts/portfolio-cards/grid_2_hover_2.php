...
<div class="portfolio-item grid-2 hover-2"<?php if ( $project['in_popup'] ) { echo ' data-portfolio-popup="' . esc_attr( $project['popup_id'] ) . '"'; } ?>>
		...
		<div class="image-wrap">
			...
			<div class="overlay">
				<div class="content-center">
					<div class="wrap text-center<?php echo esc_attr( $more_class ); ?>">
